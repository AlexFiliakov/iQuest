...
- **Last Updated**: 2025-05-30 14:15 (G085 in progress: Fix broken tests - infrastructural hotfix)
...
- **Open General Tasks**: G085 (Fix broken tests - infrastructural hotfix) [IN PROGRESS], G087 (Testing implementation strategy for 90%+ coverage)
